#pragma once
#ifndef KIWI_MIDI_PARSER_H
#define KIWI_MIDI_PARSER_H

#include <stdint.h>
#include <stdlib.h>
#include "daisy_seed.h"
#include "KiwiMidiEvent.h"
...
class KiwiMidiParser
{
  public:
     ...
     */
    bool Parse(uint8_t byte, KiwiMidiEvent *event_out);
  ...
  private:
    ...
    ParserState     pstate_;
    KiwiMidiEvent   incoming_message_;
    MidiMessageType running_status_;
    bool            needNewSysexMessage_;
