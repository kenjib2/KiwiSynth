#pragma once
#ifndef KIWI_SYNTH_KIWI_GPIO_H
#define KIWI_SYNTH_KIWI_GPIO_H
...
{
  public:
    typedef void (*InterruptCallback)(daisy::Pin pin);
    ...
    */
    void Init(daisy::Pin p, const Config &cfg);
