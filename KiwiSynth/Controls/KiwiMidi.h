...
class KiwiMidiUartTransport
{
  public:
    ...
    inline void StartRx(MidiRxParseCallback parse_callback, void* context)
    {
        ...
        dsy_dma_clear_cache_for_buffer((uint8_t*)this,
                                       sizeof(KiwiMidiUartTransport));
        uart_.DmaListenStart(
            rx_buffer, rx_buffer_size, KiwiMidiUartTransport::rxCallback, this);
    }
  ...
  private:
                           ...
                           UartHandler::Result res)
    {
        ...
        KiwiMidiUartTransport* transport
            = reinterpret_cast<KiwiMidiUartTransport*>(context);
...
class KiwiMidiHandler
{
  public:
    ...
    void StartReceive()
    {
        transport_.StartRx(KiwiMidiHandler::ParseCallback, this);
    }
     ...
     */
    KiwiMidiEvent PopEvent() { return event_q_.PopFront(); }
  ...
  private:
    ...
    KiwiMidiParser           parser_;
    FIFO<KiwiMidiEvent, 256> event_q_;

    static void ParseCallback(uint8_t* data, size_t size, void* context)
    {
        KiwiMidiHandler* handler = reinterpret_cast<KiwiMidiHandler*>(context);
 ...
 * */
using KiwiMidiUartHandler = KiwiMidiHandler<KiwiMidiUartTransport>;
//using KiwiMidiUsbHandler  = KiwiMidiHandler<KiwiMidiUsbTransport>;
/** @} */
} // namespace kiwisynth
#endif
