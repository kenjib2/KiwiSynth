...
class GpioExpansion : public IControl
{
    private:
        ...
        int numGpioExpansions_ = 4;
        IControlListener* controlListener_ = nullptr;

    public:
        bool bitValues_[4][16];
        std::vector<KiwiMcp23017> mcps_;
        GPIO interrupt_;
        ...
        /*
            ...
            */
        inline void ClearInterrupts() { for (int i = 0; i < numGpioExpansions_; i++) { mcps_.at(i).clearInterrupts(); } }
        ...
        /*
            ...
            */
        inline bool getPinValue(uint8_t address, uint8_t pin) { return bitValues_[address - 0x20][pin]; }
