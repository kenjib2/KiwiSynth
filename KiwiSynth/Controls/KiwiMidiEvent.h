...
Can be made from MidiEvent
*/
struct KiwiSystemExclusiveEvent
{
    int     length;
...
struct KiwiMidiEvent
{
    ...
    KiwiSystemExclusiveEvent AsKiwiSystemExclusive()
    {
        KiwiSystemExclusiveEvent m;
        m.finalMessage = finalSysexMessage;
