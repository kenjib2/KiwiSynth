#ifndef __KIWI_SYNTH_FLOAT_VALUE_3_SCREEN_H__
#define __KIWI_SYNTH_FLOAT_VALUE_3_SCREEN_H__
...
{
    /*
     * The float value 3 screen displays all of the bool based data and some float based data for the
     ...
     * controls.
     */
    class FloatValue3Screen
    {
        public:
            FloatValue3Screen(){}
            virtual ~FloatValue3Screen(){};
...
#endif // __KIWI_SYNTH_FLOAT_VALUE_3_SCREEN_H__
