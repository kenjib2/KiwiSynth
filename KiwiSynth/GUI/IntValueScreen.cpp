...
namespace kiwi_synth
{
    ...
    void IntValueScreen::Init(KiwiDisplay* display, PatchSettings* patchSettings)
    {
    ...
    void IntValueScreen::GetNoiseType(char* buffer) {
        switch (patchSettings->getIntValue((PatchSetting)(VCO_NOISE_TYPE))) {
            case 0:
                strcpy(buffer, "Wh");
                break;
            case 1:
    ...
    void IntValueScreen::GetLfoWaveform(char* buffer, int lfoNumber) {
        switch (patchSettings->getIntValue((PatchSetting)(LFO_1_WAVEFORM + lfoNumber))) {
            case 0:
                strcpy(buffer, "Tr");
                break;
            case 1:
    ...
    void IntValueScreen::GetModSource(char* buffer, int modNumber) {
        switch (patchSettings->getIntValue((PatchSetting)(MOD_1_SOURCE + modNumber))) {
            case 0:
                strcpy(buffer, "None ");
                break;
            case 1:
    ...
    void IntValueScreen::GetModDestination(char* buffer, int modNumber) {
        switch (patchSettings->getIntValue((PatchSetting)(MOD_1_DESTINATION + modNumber))) {
            case -1:
                strcpy(buffer, "None ");
                break;
            case 0:
