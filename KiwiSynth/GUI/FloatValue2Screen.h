#ifndef __KIWI_SYNTH_FLOAT_VALUE_2_SCREEN_H__
#define __KIWI_SYNTH_FLOAT_VALUE_2_SCREEN_H__
...
{
    /*
     * The float value 2 screen displays all of the bool based data and some float based data for the
     ...
     * controls.
     */
    class FloatValue2Screen
    {
        public:
            FloatValue2Screen(){}
            virtual ~FloatValue2Screen(){};
...
#endif // __KIWI_SYNTH_FLOAT_VALUE_2_SCREEN_H__
