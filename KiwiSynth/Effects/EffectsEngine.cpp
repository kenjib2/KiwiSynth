...
namespace kiwi_synth
{
    ...
    {
        float reverbLevel = patch->activeSettings->getFloatValue(PatchSetting::FX_REVERB);
        ...
        float decimatorLevel = patch->activeSettings->getFloatValueLinear(PatchSetting::FX_5, 0.5f, 1.0f);
